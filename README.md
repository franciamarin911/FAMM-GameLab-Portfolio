<div align="center">
  <img src="https://github.com/user-attachments/assets/bd0416ee-2fc0-4947-8323-644d096969a6" alt="Banner FAMM" width="100%" style="border-radius: 15px;">
</div>

<br>

<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Orbitron&weight=800&size=26&pause=1500&color=A855F7,22D3EE,A855F7&center=true&vCenter=true&width=850&lines=FRANCIA+ANDREA+MARIN+MORON;INGENIERIA+DE+SISTEMAS;GAME+DEVELOPER+EN+FORMACION;Code%2C+Create%2C+Conquer;Optimizando+la+realidad%2C+linea+por+linea" alt="Typing Animation" />
</div>
...
<div align="center" style="background: radial-gradient(circle at 30% 20%, #1a0b2e 0%, #0A0A0F 70%); border-radius: 18px; padding: 4px;">
<table align="center" width="100%" style="border: 2px solid #A855F7; border-radius: 16px; box-shadow: 0 0 30px rgba(168,85,247,0.4);" cellpadding="25">
  <tr>
    <td width="34%" align="center" valign="middle" style="border-right: 1px solid #2A2A35;">
      ...
      <sub style="color:#8B87A0;"><i>Avatar</i></sub>
    </td>
    <td width="66%" valign="top" style="color:#E8E5F5;">
      <h2 style="color:#22D3EE; text-shadow: 0 0 12px rgba(34,211,238,0.6);">🎴 Ficha de Personaje</h2>
      ...
      <p style="color:#E8E5F5;">¡Un cordial saludo! Soy <b style="color:#C9A6FF;">Francia Andrea Marin Moron</b>, estudiante de Ingeniería de Sistemas en la Univalle Sede La Paz. Me apasiona la tecnología y la programación, especialmente el desarrollo web, área en la que busco seguir creciendo profesionalmente.</p>
      <p style="color:#E8E5F5;">Actualmente incursiono en el desarrollo de videojuegos, enfocándome en mundos interactivos y mecánicas divertidas. También me interesan la <b style="color:#7CE7FF;">ciberseguridad</b>, el <b style="color:#7CE7FF;">IoT</b> y la <b style="color:#7CE7FF;">robótica</b>. Fuera del teclado disfruto del voleibol y manejar moto, y sigo perfeccionando mi inglés técnico para el sector tecnológico internacional.</p>
      <b style="color:#C9A6FF;">🎮 Géneros favoritos:</b>
      <br><br>
      <img src="https://img.shields.io/badge/Fighting_Games-0A0A0F?style=for-the-badge&logo=streamlit&logoColor=A855F7">
      <img src="https://img.shields.io/badge/Hack_%26_Slash-0A0A0F?style=for-the-badge&logo=swords&logoColor=22D3EE">
      <img src="https://img.shields.io/badge/MOBA-0A0A0F?style=for-the-badge&logo=leagueoflegends&logoColor=A855F7">
    </td>
  </tr>
</table>
</div>
...
<div align="center">
  <h2 style="color:#A855F7; text-shadow: 0 0 12px rgba(168,85,247,0.6);">🛠️ Stack Tecnológico</h2>
</div>

<br>

<div align="center" style="background: linear-gradient(135deg, #150826 0%, #0A0A0F 100%); border-radius: 14px; padding: 18px; box-shadow: 0 0 18px rgba(34,211,238,0.15); margin-bottom: 14px;">
  <sub><b style="color:#7CE7FF;">🚀 FRONTEND & WEB</b></sub><br><br>
...
<div align="center" style="background: linear-gradient(135deg, #1a0b2e 0%, #0A0A0F 100%); border-radius: 14px; padding: 18px; box-shadow: 0 0 18px rgba(168,85,247,0.15); margin-bottom: 14px;">
  <sub><b style="color:#C9A6FF;">⚙️ BACKEND & MÓVIL</b></sub><br><br>
...
<div align="center" style="background: linear-gradient(135deg, #150826 0%, #0A0A0F 100%); border-radius: 14px; padding: 18px; box-shadow: 0 0 18px rgba(34,211,238,0.15); margin-bottom: 14px;">
  <sub><b style="color:#7CE7FF;">🗄️ BASES DE DATOS</b></sub><br><br>
...
<div align="center" style="background: linear-gradient(135deg, #1a0b2e 0%, #0A0A0F 100%); border-radius: 14px; padding: 18px; box-shadow: 0 0 18px rgba(168,85,247,0.15); margin-bottom: 14px;">
  <sub><b style="color:#C9A6FF;">☁️ CLOUD & BaaS</b></sub><br><br>
...
<div align="center" style="background: linear-gradient(135deg, #150826 0%, #0A0A0F 100%); border-radius: 14px; padding: 18px; box-shadow: 0 0 18px rgba(34,211,238,0.15);">
  <sub><b style="color:#7CE7FF;">🛠️ HERRAMIENTAS & VERSIONADO</b></sub><br><br>
...
<div align="center">
  <h2 style="color:#22D3EE; text-shadow: 0 0 12px rgba(34,211,238,0.6);">🕹️ Galería de Videojuegos</h2>
  <p style="color:#B8B4CC;"><i>Colección de prototipos y mecánicas interactivas desarrolladas en HTML5, CSS3 y JS Canvas.</i></p>
</div>

<br><br>

<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=soft&color=gradient&colors=A855F7,7C3AED,22D3EE&height=110&section=header&text=01%20%2F%2F%20MATH%20CRUSH&fontSize=32&fontColor=ffffff&animation=fadeIn&fontAlignY=42&desc=Puzzle%20%2F%20Educativo&descAlignY=68&descSize=15&descColor=E8E5F5" alt="Math Crush Title" width="100%">
</div>
<br>
...
<table align="center" width="100%" style="border: 2px solid #22D3EE; border-radius: 16px; box-shadow: 0 0 28px rgba(34,211,238,0.4);" cellpadding="20">
  <tr>
    ...
    <td width="45%" valign="top" style="color:#E8E5F5;">
      <b style="color:#7CE7FF;">🎯 Objetivo:</b> <span style="color:#E8E5F5;">Encontrar el número objetivo seleccionando dos números vecinos y la operación matemática correcta (+, −, × o ÷) antes de que acaben los 60 segundos.</span><br><br>
      <b style="color:#7CE7FF;">📝 Descripción:</b>
      <blockquote style="color:#C9C4E0; border-left: 3px solid #22D3EE; padding-left: 10px;">Un juego matemático rápido y colorido con estética RGB gamer.</blockquote><br>
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=soft&color=gradient&colors=22D3EE,7C3AED,A855F7&height=110&section=header&text=02%20%2F%2F%20TRASHKETBALL&fontSize=32&fontColor=ffffff&animation=fadeIn&fontAlignY=42&desc=Arcade%20%2F%20Trayectoria&descAlignY=68&descSize=15&descColor=E8E5F5" alt="Trashketball Title" width="100%">
</div>
<br>
...
<table align="center" width="100%" style="border: 2px solid #A855F7; border-radius: 16px; box-shadow: 0 0 28px rgba(168,85,247,0.4);" cellpadding="20">
  <tr>
    ...
    <td width="45%" valign="top" style="color:#E8E5F5;">
      <b style="color:#C9A6FF;">🎯 Objetivo:</b> <span style="color:#E8E5F5;">Encestar residuos en contenedores móviles dominando la física avanzada, el viento dinámico y obstáculos rebotadores para generar combos.</span><br><br>
      <b style="color:#C9A6FF;">📝 Descripción:</b>
      <blockquote style="color:#C9C4E0; border-left: 3px solid #A855F7; padding-left: 10px;">Simulador arcade de reciclaje con físicas dinámicas.</blockquote><br>
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=soft&color=gradient&colors=A855F7,7C3AED,22D3EE&height=110&section=header&text=03%20%2F%2F%20VERDU-CHAN&fontSize=32&fontColor=ffffff&animation=fadeIn&fontAlignY=42&desc=Survival%20%2F%20Roguelite&descAlignY=68&descSize=15&descColor=E8E5F5" alt="Verdu-Chan Title" width="100%">
</div>
<br>
<div align="center" style="background: linear-gradient(160deg, #0d1f24 0%, #0A0A0F 60%); border-radius: 20px; padding: 4px;">
<table align="center" width="100%" style="border: 2px solid #22D3EE; border-radius: 16px; box-shadow: 0 0 28px rgba(34,211,238,0.4);" cellpadding="20">
  <tr>
    ...
    <td width="45%" valign="top" style="color:#E8E5F5;">
      <b style="color:#7CE7FF;">🎯 Objetivo:</b> <span style="color:#E8E5F5;">Controlar a una zanahoria que ataca automáticamente, recolectando verduras sanas para subir de nivel y obtener mejoras estilo roguelite.</span><br><br>
      <b style="color:#7CE7FF;">📝 Descripción:</b>
      <blockquote style="color:#C9C4E0; border-left: 3px solid #22D3EE; padding-left: 10px;">Sobrevive a las oleadas de comida chatarra.</blockquote><br>
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=soft&color=gradient&colors=22D3EE,7C3AED,A855F7&height=110&section=header&text=04%20%2F%2F%20GOTITAS%20MAGICAS&fontSize=30&fontColor=ffffff&animation=fadeIn&fontAlignY=42&desc=Arcade%20%2F%20Educativo&descAlignY=68&descSize=15&descColor=E8E5F5" alt="Gotitas Magicas Title" width="100%">
</div>
<br>
<div align="center" style="background: linear-gradient(160deg, #1a0b2e 0%, #0A0A0F 60%); border-radius: 20px; padding: 4px;">
<table align="center" width="100%" style="border: 2px solid #A855F7; border-radius: 16px; box-shadow: 0 0 28px rgba(168,85,247,0.4);" cellpadding="20">
  <tr>
    ...
    <td width="45%" valign="top" style="color:#E8E5F5;">
      <b style="color:#C9A6FF;">🎯 Objetivo:</b> <span style="color:#E8E5F5;">Controlar una canasta para recolectar gotas de agua puras y power-ups, esquivando hábilmente la caída de basura y toxinas.</span><br><br>
      <b style="color:#C9A6FF;">📝 Descripción:</b>
      <blockquote style="color:#C9C4E0; border-left: 3px solid #A855F7; padding-left: 10px;">Salva a Ajolí el Ajolote y purifica su hábitat acuático.</blockquote><br>
...
<div align="center">
  <h3 style="color:#A855F7; text-shadow: 0 0 12px rgba(168,85,247,0.6);">🚀 Sigamos creando</h3>
  <p style="color:#B8B4CC;"><i>Siempre abierta a colaborar en proyectos de desarrollo web y videojuegos.</i></p>
  <a href="https://github.com/franciamarin911" target="_blank" rel="noopener noreferrer">
